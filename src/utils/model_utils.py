...
class BaseModel(nn.Module):
    def __init__(self,
        ...
        self.bert_module = BertModel.from_pretrained(bert_dir,
                                                     ...
                                                     hidden_dropout_prob=dropout_prob,add_pooling_layer=False)
        # self.bert_module = BertForSequenceClassification.from_pretrained(bert_dir,
        #                                              output_hidden_states=True,
        #                                              hidden_dropout_prob=dropout_prob,num_labels = 768)
...
class CRFModel(BaseModel):
    def __init__(self,
        ...
        # for p in self.bert_module.parameters():
        #     print(p.size())
        # exit()
    ...
    def forward(self,
        ...
        if labels is not None:
            ...
            out = (tokens_loss,emissions)

        else:
            print("labels is none, decode")
