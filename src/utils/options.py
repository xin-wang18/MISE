...
class Args:
    ...
    def initialize(parser: argparse.ArgumentParser):
        ...
        parser.add_argument('--task_num', default=6, type=int)
        parser.add_argument('--meta_lr', default=2e-5, type=float)
        parser.add_argument('--update_lr', default=1e-4, type=float)
        ...
        parser.add_argument('--query', default=20, type=int)
        # test args
