...
class NERProcessor:
    ...
    def get_examples(self, raw_examples, set_type):
        ...
        for i, item in enumerate(raw_examples):
            ...
            # print(distant_labels,type(distant_labels))
            # print(item)
            # exit()
            # pseudo = item['pseudo']
            pseudo = i
